...
//        Log.println(Log.INFO, targetID, "parseJSON");
        ...
        try {
                ...
                while (iter.hasNext()) {
                    ...
                    switch (key) {
                        ...
                        case "detail":
                            ...
                            break;
                        case "time_stamp":
                            time_stamp = obj.getLong(key);
                            Log.d("timestamp : ", Long.toString(time_stamp));;
                            break;
                    }
                }

                Log.println(Log.DEBUG, targetID, "JSON:"+priority+"/"+type+"/"+subject+"/"+detail+"/"+time_stamp);
                Transaction t = new Transaction(priority, type, subject, detail, time_stamp);
            ...
            for (Transaction s1 : warningMessage)
            {
                ...
                Log.println(Log.DEBUG, targetID, "timestamp: " + s1.time_stamp);
            }
    ...
    public ArrayList<Transaction> parseJSONArray(JSONArray array) {
        ArrayList<Transaction> warningMessage = new ArrayList<>();
        String priority = "";
        String type = "";
        String subject = "";
    ...
    public ArrayList<Transaction> parseJSONObject(JSONObject obj) {
        ArrayList<Transaction> warningMessage = new ArrayList<>();
        String priority = "";
        String type = "";
        String subject = "";

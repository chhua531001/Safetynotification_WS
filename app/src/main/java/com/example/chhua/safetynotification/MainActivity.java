...
//        {
//
//            Log.println(Log.INFO, targetID, "mConnectivityReceiver");
...
//                useMobileNetwork = mNetworkInfo.getType() == ConnectivityManager.TYPE_WIFI;
//                final String msg = "Connect:" + noConnectivity + "\nUse3G:" + useMobileNetwork;
//                Log.println(Log.INFO, targetID, "Wifi is Turn-On");
//            }
//            else {
...
//
            ...
            tools.toastNow(mContext, "網路不存在, 請打開WiFi連線", Color.WHITE);
        }
    }
...
//            startActivityForResult(intent,1);
        ...
        Log.println(Log.DEBUG, targetID, "Network Online Status = " + tools.isNetworkOnline(mContext));
